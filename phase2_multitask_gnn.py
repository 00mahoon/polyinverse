...
for epoch in range(300):
    ...
    if (epoch + 1) % 50 == 0:
        ...
        print(f"Epoch {epoch+1:>3}/300 | Loss: {avg_loss:.4f} | Density R²: {r2_d:.3f} | Tc R²: {r2_t:.3f}")
        if (r2_d + r2_t) / 2 > best_r2:
            best_r2 = (r2_d + r2_t) / 2
...
print(f"\n=== Multi-task GNN Best Performance ===")
...
plt.tight_layout()
plt.savefig('multitask_gnn.png')
print("Saved: multitask_gnn.png")

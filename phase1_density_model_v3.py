...
plt.title(f'Density Prediction v3 XGBoost (R²={r2:.3f})')
plt.tight_layout()
plt.savefig('density_prediction_v3.png')
print("Saved: density_prediction_v3.png")
